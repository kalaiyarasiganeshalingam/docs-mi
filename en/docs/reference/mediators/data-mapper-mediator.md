...
another, or changes the structure of the data in a message. It provides a graphical mapping configuration with
MI VS Code Extension and generates the files required for executing this graphical mapping
...
When you add data mapper from the scratch, above files will be created automatically in a Registry Resource of the project as shown in the example below.

[![Generated configuration files]({{base_path}}/assets/img/integrate/mediators/119131284/119135195.png){: style="width:50%"}]({{base_path}}/assets/img/integrate/mediators/119131284/119135195.png)
